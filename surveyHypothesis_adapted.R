...
# testGroupDataClean <- filter(testGroupDataClean, timeOnText >= timeOnTextThreshold)
# controlGroupDataClean <- filter(controlGroupDataClean, timeOnText >= timeOnTextThreshold)
# 
