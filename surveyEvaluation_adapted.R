...
getSurveyDataAdapted <- function(surveyData, selectionMatrixBigFive, isInvertedNfc, isInvertedBigFive, attributesBigFive, overuseThreshold = 8) {
  ...
  testGroupDataClean <- getCleanDataAdapted(testGroupData, "test", isInvertedNfc)
  ...
  controlGroupDataClean <- getCleanDataAdapted(controlGroupData, "control", isInvertedNfc)
